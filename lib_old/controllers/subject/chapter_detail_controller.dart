...
class ChapterDetailController extends GetxController {
  ...
  bool isVideoLocked(Video video) => video.isLocked && !_isPreviewChapterAccess;
  bool isQuizLocked(Exam quiz) => quiz.isLocked && !_isPreviewChapterAccess;
  bool isNoteLocked(Note note) => note.isLocked && !_isPreviewChapterAccess;
  ...
  void loadChapterDetail() async {
    ...
    try {
      ...
      _isSubjectLocked = subject?.isLocked ?? true;
      _chapter = subject?.chapters.firstWhereOrNull((ch) => ch.id == chapterId);
      _isPreviewChapterAccess =
